...
import IdCardPreview from './components/IdCardPreview.jsx';
import PfpFramePreview from './components/PfpFramePreview.jsx';
          ...
          <div className="studio-grid">
            ...
            <div className="preview-panel">
              ...
              <div className="dom-card-container">
                <div ref={cardRef}>
                  {format === 'id_card' ? (
                    <IdCardPreview data={data} photoUrl={photoUrl} getFilterStyle={getFilterStyle} />
                  ) : (
                    <PfpFramePreview data={data} photoUrl={photoUrl} getFilterStyle={getFilterStyle} />
                  )}
                </div>
              </div>
